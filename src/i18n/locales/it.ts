export const it = {
  ...
  goals: {
    ...
    journeyBooks_one: "{{count}} libro all'anno",
    journeyBooks_other: "{{count}} libri all'anno",
  ...
  badges: {
    pageTitle: "Badge",
    seeAll: "Vedi tutti",
    featuredTitle: "Badge in evidenza",
    edit: "Modifica",
    featuredEmpty: "Scegli fino a {{count}} badge da mostrare sul tuo profilo.",
    featuredEmptyCta: "Scegli badge",
    allTitle: "Tutti i badge",
    unlockedCount: "{{unlocked}} di {{total}} sbloccati",
    lockedLabel: "{{title}}, da sbloccare",
    // Dettaglio
    progressLabel: "Avanzamento",
    progress: {
      books_completed: "{{current}} di {{target}} libri",
      pages_read: "{{current}} di {{target}} pagine",
      longest_book_pages: "{{current}} di {{target}} pagine",
      goals_completed: "{{current}} di {{target}} obiettivi",
    },
    ...
    featuredRemoved: "Badge rimosso dall'evidenza",
    // Selettore
    pickerTitle: "Scegli badge in evidenza",
    pickerHint:
      "Puoi sceglierne fino a {{count}} da mostrare sul tuo profilo. Scegli quelli che rappresentano meglio il tuo percorso di lettura!",
    pickerCounter: "{{selected}}/{{max}}",
    pickerCounterLabel: "selezionati",
    featuredSaved: "Badge in evidenza aggiornati",
  },
  notifications: {
    title: "Notifiche",
    bell: "Notifiche",
    bellUnread_one: "Notifiche, {{count}} non letta",
    bellUnread_other: "Notifiche, {{count}} non lette",
    markAllRead: "Segna tutte come lette",
    deleteAction: "Elimina",
    swipeHint: "Scorri verso sinistra per eliminare.",
    badgeUnlocked: "Nuovo badge sbloccato",
    badgeUnlockedGeneric: "Hai sbloccato un nuovo badge",
    goalRenewalAchieved: "Obiettivo settimanale raggiunto",
    goalRenewalConcluded: "Obiettivo settimanale concluso",
    ...
    releaseOn: "Esce {{date}}",
    reminderAsk: "Vuoi un promemoria il giorno dell'uscita?",
    reminderOn: "Promemoria attivo",
    reminderOnHint: "Ti avviseremo {{date}}.",
    reminderEnable: "Attiva promemoria",
    reminderDisable: "Disattiva",
